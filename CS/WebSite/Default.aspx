...
<body>
    <form id="form1" runat="server">
        ...
        <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="~/App_Data/Northwind.mdb"
            SelectCommand="Select [CategoryID], &quot;&lt;span title='&quot;+[Description]+&quot;'&gt;&quot;+[CategoryName]+&quot;&lt;/span&gt;&quot; as [CustomDataField] FROM Categories"></asp:AccessDataSource>
            <br />
            <br />
            <strong>Custom values: </strong>
            <dx:ASPxComboBox ID="ASPxComboBox3" runat="server" EncodeHtml="False" ValueType="System.String" OnInit="ASPxComboBox3_Init">
            </dx:ASPxComboBox>
